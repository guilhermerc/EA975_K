...
let HeroDetailComponent = class HeroDetailComponent {
    constructor(route, location, heroService) {
        this.route = route;
...
let HeroService = class HeroService {
    ...
    getHero(id) {
        ...
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(_mock_heroes__WEBPACK_IMPORTED_MODULE_5__["HEROES"].find(hero => hero.id === id));
    }
