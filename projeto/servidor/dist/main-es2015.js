...
let CriticaComponent = class CriticaComponent {
    ...
    constructor(dialogRef, filmeService, router, dados) {
        this.dialogRef = dialogRef;
        ...
        if (dados.critica != null) {
            ...
            this.critica = Object.assign({}, dados.critica);
...
let EdicaoFilmeComponent = class EdicaoFilmeComponent {
    constructor(route, filmeService, location, router, usuarioService) {
        this.route = route;
        this.filmeService = filmeService;
...
let FilmeService = class FilmeService {
    ...
    *   3. "id/id do filme"
    */
    getFilmes(filtro, conteudoDeBusca) {
        var url;
        if (conteudoDeBusca == "") {
            url = '/filmes/';
        }
...
let PerfilUsuarioComponent = class PerfilUsuarioComponent {
    ...
    editarPerfile() {
        ...
        this.usuarioOriginal = Object.assign({}, this.usuario);
...
let UsuarioService = class UsuarioService {
    ...
    putUsuario(usuarioAlterado, body) {
